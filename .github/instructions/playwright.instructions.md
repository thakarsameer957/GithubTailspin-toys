...
- **Clarity**: Use descriptive test and step titles that clearly state the intent. Add comments only to explain complex logic or non-obvious interactions, and keep them focused on why the setup or assertion exists rather than restating the code.
...
- [ ] Code is properly formatted and comments explain intent rather than repeating the code
